...
final as (
    ...
    select
        ...
        {{ tiktok_ads_fill_pass_through_columns(pass_through_fields=var('tiktok_ads__ad_hourly_passthrough_metrics')), except=["real_time_conversion", "total_purchase_value", "total_sales_lead_value"] }}
