[PR #33](https://github.com/fivetran/dbt_tiktok_ads_source/pull/33) includes the following updates:
...
[PR #31](https://github.com/fivetran/dbt_tiktok_ads_source/pull/31) includes the following updates:
...
If you are using dbt Core < 1.9.6 and want to continue running TikTok Ads freshness tests, please elect **one** of the following options:
